...
impl JsonData {
    ...
    pub fn anaslysis(&self, ipstr: &str, addr: &std::net::SocketAddr, handle: &tauri::AppHandle, connection: &self::SqlConArc, uid: &self::UidArc, socket: &self::UdpArc) -> Result<(), Box<dyn std::error::Error>> {
